...
values."
  (setq-default
   ...
   dotspacemacs-configuration-layer-path '("~/.emacs.d/private/custom-layers")
   ...
   '(
     ...
     bibtex
     (mu4e :variables
           mu4e-maildir "/jonfiles/Email/Maildir"
...
you should place your code here"
  ;;; Format line numbers and highlights + colors
  ;; Set fringe color
  (set-face-background 'fringe "#4d5656")
  ;; Set line number color
  (set-face-foreground 'line-number "#28b463")
  ;; Set selected line highlight color
  (set-face-background 'line-number-current-line "#4d5656")
  ;; Set line highlight color
  (set-face-background 'hl-line "#4d5656"))

  ;;; Org mode config
  ;; Set directory for agenda files
  (setq org-agenda-files '("/jonfiles/Projects/Notes/Org-Agenda-Files/todos.org"))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (srcery-theme mu4e-maildirs-extension mu4e-alert helm-mu org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download htmlize gnuplot spinner evil-visualstar evil-visual-mark-mode evil-tutor evil-surround evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state iedit evil-exchange evil-ediff evil-args evil-anzu anzu evil undo-tree adaptive-wrap ws-butler winum which-key wgrep volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline smex smartparens restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint ivy-hydra indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-make google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-unimpaired evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-escape goto-chg eval-sexp-fu elisp-slime-nav dumb-jump popup f dash s diminish define-word counsel-projectile projectile pkg-info epl counsel swiper ivy column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed async aggressive-indent ace-window ace-link avy))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
